          ...
          <div className="bg-neutral-950 py-4 sm:py-6 lg:py-8 px-4 sm:px-6 h-full w-full flex flex-col justify-between">
            <div className="flex shrink-0 gap-8 sm:gap-12 lg:gap-20">
              <div className="flex flex-col gap-1 sm:gap-2">
                ...
                <span className="text-white text-sm sm:text-base">Упаковка сообщества</span>
                <span className="text-white text-sm sm:text-base">Таргет ВКонтакте</span>
                <span className="text-white text-sm sm:text-base">Менеджер по продажам</span>
                <span className="text-white text-sm sm:text-base">Яндекс Карты</span>
              </div>
              <div className="flex flex-col gap-1 sm:gap-2">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 sm:gap-0">
              ...
              <p className="text-neutral-500 text-sm sm:text-base">{new Date().getFullYear()} АЗИмпакт</p>
            </div>
          </div>
        </div>
      </div>
